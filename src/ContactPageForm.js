               ...
               <form className={'mr-auto'}>
                        <fieldset>
                            ...
                            <p className={'text-left ml-8 pb-4'}>Full Name</p>
                                <textarea className={'border w-2/3 px-1 outline-none rounded text-left'} placeholder={'Place your name..'} />
                            </label>
                        </fieldset>
                        <fieldset>
                            <label>
                            <p className={'text-left ml-8 py-4'}>Subject</p>
                                <textarea className={'border w-2/3 px-1 outline-none rounded'} placeholder={'Place your name..'} />
                            </label>
                        </fieldset>
                        <fieldset>
                            <label>
